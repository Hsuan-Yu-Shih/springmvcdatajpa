...
@Controller public class PokemonController {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/pokemanage") public ModelAndView home() {
        List<Pokemon> listPokemon = pokemonService.listAll();
        for (Pokemon Pokemon : listPokemon) {
            System.out.println(Pokemon.toString());
        }
        ModelAndView mav = new ModelAndView("pokemanage");
        mav.addObject("listPokemon", listPokemon); return mav;
    }
    ...
    public ModelAndView editPokemonForm(@RequestParam long id) {
        ...
        Pokemon pokemon = pokemonService.get(id); mav.addObject("pokemon", pokemon);
        return mav;
    }
    ...
    public String deletePokemonForm(@RequestParam long id) {
        pokemonService.delete(id); return "redirect:/pokemanage";
    }
